...
// Đóng dropdown nếu người dùng nhấn ra ngoài dropdown
        ...
        if (cookies != null) {
            for (Cookie cookie : cookies) {
                if (cookie.getName().equals("role-cookie")) {
                    String roleCookieValue = cookie.getValue();
                    break;
                }
            }
        }
    ...
    <main style="background-color: #e0e0e0">
        <nav class="navbar navbar-expand-lg navbar-dark pb-3 pt-3 " style="background-color: #e0e0e0">
            <!-- Container wrapper -->
            <div class="container-fluid">

                <!-- Navbar brand -->
                <a class="navbar-brand" href="productlist"><img src="./images/logonike1.png" alt="alt" style="width: 120px;"/></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent2">
                    ...
                    <c:if test="${not empty cookie['uid-cookie']}">
                        ...
                        <div id="dropdown" class="dropdown-content">
                            ...
                            <form action="logout" method="post" ">
                                <button style="background-color: #f9f9f9; border: none; width: 100%; text-align: left; padding: 0" type="submit"><a>Logout</a></button>
                            </form> 
                    ...
                    <c:if test="${empty cookie['uid-cookie']}">
                        <button  style="padding:0 15px"  class="account-button">
                            <a href="${pageContext.request.contextPath}/login"><i class="fas fa-user"></i></a>
                        </button>
                    </c:if>
                    <c:choose>
                        <c:when test="${requestScope.role != null && requestScope.role == '1' }">
                            <form action="./Account/admin.jsp">
                                <button class="cart-button">
                                    <i class="fas fa-solid fa-user-tie"></i>
                                </button>
                            </form>
                        </c:when>
                        <c:when test="${requestScope.role != null && requestScope.role == '2' }">
                            <form action="./Account/staff.jsp">
                                <button class="cart-button">
                                    <i class="fas fa-solid fa-user-tie"></i>
                                </button>
                            </form>
