...
<html>
    ...
    <body>
        ...
        <h2>List of Product - page ${requestScope.page} </h2>
        ...
        <table border="1">
            ...
            <c:forEach var="product" items="${requestScope.data}">
                <tr>
                    ...
                    <td><image style="width: 100px" src="${product.getImage()}"></td>
                    <td>${product.getCategory().getName()}</td>
                    <td>
                        <a href="deleteproduct?id=${product.getProductId()}" style="color: red; text-decoration: none">Delete</a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="updateproduct?id=${product.getProductId()}" style="color: blue; text-decoration: none">Update</a>
                    </td>
                </tr>
            </c:forEach>
