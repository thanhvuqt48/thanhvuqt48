...
public class EmployeeServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<Employee> list1 = ed.getAll();
        int page, numberElementsInPage = 15;
        int size = list1.size();
        int numberPage = (size % numberElementsInPage == 0) ? (size / 15) : (size / 15 + 1);
        ...
        List<Employee> list = ed.getListByPage(list1, start, end);
