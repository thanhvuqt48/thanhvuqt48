...
public class AddServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Magazine mg = md.getMagazineById(id);

            if (mg == null) {
                Magazine m = new Magazine(id, name, num, publisher);
                md.insert(m);
                response.sendRedirect("magazine");
            } else {
            ...
            request.setAttribute("error", "Issue number must be number");
            request.getRequestDispatcher("addMagazine.jsp").forward(request, response);
        }
    }
